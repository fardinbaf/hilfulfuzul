...
import { Phone, Mail, MapPin, Heart, MessageCircleHeart, ShieldCheck } from 'lucide-react';
    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          ...
          <NavLink to="/admin" className="text-xs text-gray-600 hover:text-gray-400 inline-flex items-center mt-2">
